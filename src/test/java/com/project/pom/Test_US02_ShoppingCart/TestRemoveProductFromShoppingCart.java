...
public class TestRemoveProductFromShoppingCart {
    ...
    public void ShoppingCart () throws Exception {
        ...
        if(pageHome.logoVisible()){
            ...
            pageShoppingCart.btnActionDelete(screenPath);
            pageProductDetails.setCartCounter();
            Assert.assertEquals(pageShoppingCart.verifyTitleCartEmpty(), Parameters.expectedResultEmptyCart);
            Assert.assertEquals(pageShoppingCart.verifyCartCounter(), Parameters.cartCounter);
        }
